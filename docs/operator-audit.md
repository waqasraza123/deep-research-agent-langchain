...
disclosure reports, handoff manifests, handoff registries, or cleanup state. It is file-backed and
uses the same `runs/` artifact layout as the rest of the service.
