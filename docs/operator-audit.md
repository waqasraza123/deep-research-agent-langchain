...
verifications, release attestations, attestation verifications, portfolio receipts, or cleanup
state. It is file-backed and uses the same `runs/` artifact layout as the rest of the service.
