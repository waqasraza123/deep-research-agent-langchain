...
synthesis, custody certificate, integrity report, disclosure report, handoff manifest, and summary
artifacts. It is meant for a compact operator handoff and excludes raw source payloads by default.
